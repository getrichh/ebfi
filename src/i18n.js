...
const resources = {
	en: {
		translation: {
			...
			"Europe": "Europe",
			"Ukraine": "DMK Ukraine",
			"Azovstal":"Azovstal + Ilyich Iron and Steel Works + Zaporozhstal, Ukraine",
	...
	ru: {
		translation: {
			...
			"Europe": "Европа",
			"Ukraine": "ДМК Украина",
			"Azovstal":"Азовсталь + МК Ильича + Запорожсталь, Украина",
